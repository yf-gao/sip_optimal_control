...
#ifndef SIPOC_MR_NAV2_CONTROLLER__NOMINAL_DILATED_POLYGON_HPP_
#define SIPOC_MR_NAV2_CONTROLLER__NOMINAL_DILATED_POLYGON_HPP_
...
{
    class NominalDilatedPolygonController : public nav2_core::Controller
    {
    ...
    public:
        ...
        NominalDilatedPolygonController() = default;
        ~NominalDilatedPolygonController() override = default;
    ...
    protected:
        ...
        // Controller
        std::shared_ptr<sipoc_mr_solver::DilatedPolygonNominalController> ptr_controller_;
...
#endif // SIPOC_MR_NAV2_CONTROLLER__NOMINAL_DILATED_POLYGON_HPP_
