...
#ifndef SIPOC_MR_NAV2_CONTROLLER__CAPSULE_NOMINAL_HPP_
#define SIPOC_MR_NAV2_CONTROLLER__CAPSULE_NOMINAL_HPP_
...
{
    class NominalCapsuleController : public nav2_core::Controller
    {
    ...
    public:
        ...
        NominalCapsuleController() = default;
        ~NominalCapsuleController() override = default;
    ...
    protected:
        ...
        // Controller
        std::shared_ptr<sipoc_mr_solver::CapsuleNominalController> ptr_controller_;
...
#endif // SIPOC_MR_NAV2_CONTROLLER__CAPSULE_NOMINAL_HPP_
