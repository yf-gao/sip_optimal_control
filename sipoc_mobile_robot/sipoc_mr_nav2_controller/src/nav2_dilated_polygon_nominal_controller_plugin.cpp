...
#include "sipoc_mr_nav2_controller/nav2_dilated_polygon_nominal_controller_plugin.hpp"
...
namespace sipoc_mr_nav2_controller
{
    ...
    void NominalDilatedPolygonController::configure(
        ...
        std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
    {
        ...
        ptr_controller_ = std::make_shared<sipoc_mr_solver::DilatedPolygonNominalController>(nav2_plugin_params_.ocp);
        ...
        {
            sub_laser_scan_ = node->create_subscription<sensor_msgs::msg::LaserScan>("scan", 1, std::bind(&NominalDilatedPolygonController::FilteredLaserCallback, this, std::placeholders::_1));
            sub_occ_map_ = nullptr;
        }
        else
        {
            sub_occ_map_ = node->create_subscription<nav_msgs::msg::OccupancyGrid>("global_costmap", 1, std::bind(&NominalDilatedPolygonController::OccupancyMapCallback, this, std::placeholders::_1));
            sub_laser_scan_ = nullptr;
        }
    }

    void NominalDilatedPolygonController::declareAndGetParams()
    {
        auto node = node_.lock();
    ...
    void NominalDilatedPolygonController::activate()
    {
        RCLCPP_INFO(logger_, "Activating controller: sipoc_mr_nav2_controller::NominalDilatedPolygonController");
    ...
    void NominalDilatedPolygonController::deactivate()
    {
        RCLCPP_INFO(logger_, "Dectivating controller: sipoc_mr_nav2_controller::NominalDilatedPolygonController");
    ...
    void NominalDilatedPolygonController::cleanup()
    {
        RCLCPP_INFO(logger_, "Cleaning up controller: sipoc_mr_nav2_controller::NominalDilatedPolygonController");
        pub_ref_path_.reset();
        pub_ref_traj_.reset();
    ...
    void NominalDilatedPolygonController::setSpeedLimit(const double &speed_limit, const bool &percentage)
    {
    ...
    void NominalDilatedPolygonController::setPlan(const nav_msgs::msg::Path &path)
    {
        global_plan_ = path;
    }

    geometry_msgs::msg::TwistStamped NominalDilatedPolygonController::computeVelocityCommands(
        ...
        const geometry_msgs::msg::Twist &velocity, nav2_core::GoalChecker *)
    {
        ...
        ptr_state_predictor_filter_->predictOCPInitialState(cb_acc_hist_, ocp_init_state, true); // NOTE: set to false for without-sysid
    ...
    void NominalDilatedPolygonController::OccupancyMapCallback(nav_msgs::msg::OccupancyGrid msg)
    {
        if (!occ_map_updated_)
        {
    ...
    void NominalDilatedPolygonController::FilteredLaserCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
    {
        // MUTEX NEEDED?!?
    ...
    bool NominalDilatedPolygonController::buildReferencePath(const nav_msgs::msg::Path &global_plan,
    ...
    void NominalDilatedPolygonController::resetFilterBuffers()
    {
        cb_acc_hist_.clear();
    ...
    void NominalDilatedPolygonController::computeReferenceTraj(const manif::SE2<double> &current_pose,
    ...
    void NominalDilatedPolygonController::publishReferencePath(const rclcpp::Time &t)
    {
    ...
    void NominalDilatedPolygonController::publishReferenceTrajectory(const rclcpp::Time &t)
    {
    ...
    void NominalDilatedPolygonController::publishLocalPlan(const rclcpp::Time &t)
    {
    ...
    void NominalDilatedPolygonController::publishTimings(const rclcpp::Time &t)
    {
    ...
    void NominalDilatedPolygonController::publishObstacle(const rclcpp::Time &t)
    {
    ...
    void NominalDilatedPolygonController::publishVelPredictOCP(const rclcpp::Time &t, const manif::SE2Tangent<double> &robot_twist)
    {
...
PLUGINLIB_EXPORT_CLASS(sipoc_mr_nav2_controller::NominalDilatedPolygonController, nav2_core::Controller)
