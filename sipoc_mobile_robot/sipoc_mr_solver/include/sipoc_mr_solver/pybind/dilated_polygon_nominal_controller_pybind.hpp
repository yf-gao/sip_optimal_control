...
#ifndef SIPOC_MR_CONTROLLER__DILATED_POLYGON_NOMINAL_CONTROLLER_PYBIND_HPP_
#define SIPOC_MR_CONTROLLER__DILATED_POLYGON_NOMINAL_CONTROLLER_PYBIND_HPP_
...
{
    class DilatedPolygonNominalControllerPybind : public DilatedPolygonNominalController
    {
    public:
        DilatedPolygonNominalControllerPybind() : DilatedPolygonNominalController()
        {
        }

        DilatedPolygonNominalControllerPybind(int n_hrzn, double delta_t) : DilatedPolygonNominalController(n_hrzn, delta_t)
        {
        }

        DilatedPolygonNominalControllerPybind(int n_hrzn, double delta_t, double robot_polygon_dilation_radius) : DilatedPolygonNominalController(n_hrzn, delta_t)
        {
...
#endif // SIPOC_MR_CONTROLLER__DILATED_POLYGON_NOMINAL_CONTROLLER_PYBIND_HPP_
